...
<head>
    ...
    <title>projectBlog1</title>

    <!-- Bootstrap -->
    <link href="<?php echo PublicPath.'css/bootstrap.min.css'; ?>" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo PublicPath.'Site_Css/Site_header.css'; ?>">
